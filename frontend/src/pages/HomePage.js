...
const HomePage = () => {
  ...
  const levels = [
    ...
    { range: \"300-349\", title: \"Libraries & APIs\", description: \"Working with external libraries and APIs\", difficulty: \"Advanced\" },
      ...
      <section className=\"py-20 px-4 sm:px-6 lg:px-8\">
        <div className=\"max-w-4xl mx-auto text-center\">
          ...
          <p className=\"text-xl text-gray-600 mb-8\">
            Join thousands of learners and start coding today. It's free to get started!
          </p>
          <Button
            asChild
            size=\"lg\"
